  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center h-screen">
        <div className="flex flex-col items-center shadow-md bg-orange-100 w-96 border  m-5 p-5 rounded-xl">
        ...
        <div className="flex flex-col m-5 p-5 bg-blue-100 items-center w-96  shadow-md mb-5 rounded">
          ...
          <ul className="w-full">
            {list.map((item) => (
              ...
              >
                {" "}
                <li className="text-black-800 font-medium  rounded-xl">
                  {item.title}
                </li>
                <button
